...
RUN yum install perl perl-JSON perl-libwww-perl perl-XML-Parser perl-Net-SSLeay perl-Excel-Writer-XLSX perl-Time-HiRes unzip \
graphite-web mysql mysql-server MySQL-python python-carbon expect -y
RUN yum -y install https://grafanarel.s3.amazonaws.com/builds/grafana-2.5.0-1.x86_64.rpm; yum clean all
